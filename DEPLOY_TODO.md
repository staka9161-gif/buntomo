...
9. 30日後完全削除機能の実装(退会フロー) -- 利用規約第7条に記載済み、実装が必要
10. 管理者用ユーザー管理画面(検索、停止、削除)
11. 管理者用一斉送信メール機能
12. Google Analytics 導入 -- プライバシーポリシー第4条に導入予定と記載済み
13. 通報受付機能(将来)
14. お問い合わせフォーム -- 現状は mailto: リンク、将来的にフォームに置換も検討
