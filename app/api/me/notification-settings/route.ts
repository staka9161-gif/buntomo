...
export async function PATCH(request: NextRequest) {
  try {
    ...
    if (typeof body.emailNotifFriendRequest === "boolean") {
      data.emailNotifFriendRequest = body.emailNotifFriendRequest;
    }
    if (typeof body.emailNotifFriendAccepted === "boolean") {
      data.emailNotifFriendAccepted = body.emailNotifFriendAccepted;
    }
