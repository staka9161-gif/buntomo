  ...
  return (
    <div className="mt-8 rounded-xl border border-red-200 bg-red-50/50 p-6">
      ...
      <p className="mt-2 text-xs leading-relaxed text-red-600/80">
        退会するとすぐに利用停止となり、他のユーザーからプロフィール等は原則表示されなくなります。30日以内にログインすると復元できますが、30日を過ぎるとアカウント情報等の削除処理が行われ、復元できなくなります。法令対応・不正防止・セキュリティ・運営上必要な最小限の記録や、個人を直接識別できない統計情報等は保持される場合があります。
      </p>
